...
export const AI_COMPANIONS: CompanionConfig[] = [
  ...
  { id: 'meryl', name: 'Gloria', colorPrimary: '#C9A84C', colorSecondary: '#8B6914', iconName: 'Award' },
  { id: 'nikki', name: 'Razor', colorPrimary: '#EC4899', colorSecondary: '#9D174D', iconName: 'Mic' },
  { id: 'will',  name: 'Buddy', colorPrimary: '#EAB308', colorSecondary: '#92400E', iconName: 'HelpCircle' },
]
