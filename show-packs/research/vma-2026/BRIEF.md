...
| D4 | Bingo | Live-show moments only, self-marked. The pool holds at least twice the dealt board mix in every tier (at least 14 likely, 18 toss-up, 12 long-shot, 4 chaos; 56 to 64 squares) with nothing priced above 80, so six players share a mean of about 7 of 24 squares instead of 14. Probabilities authored against 2023 to 2025 VMA history. Host-adjudicated bingo is **not** built for this show (see section 8). |
